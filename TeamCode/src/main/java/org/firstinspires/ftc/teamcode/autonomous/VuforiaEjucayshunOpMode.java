...
@Autonomous(name="VuforiaEjucayshunOpMode", group = "bot")
public class VuforiaEjucayshunOpMode extends LinearOpMode {
        ...
        while (opModeIsActive()) {
            ...
            if (vuMark != RelicRecoveryVuMark.UNKNOWN) {
                ...
                if (pose != null) {
                    ...
                    telemetry.addLine("X trans:" + trans.get(0));
                    double tY = trans.get(1);
                    telemetry.addLine("Y trans:" + trans.get(1));
                    double tZ = trans.get(2);
                    telemetry.addLine("Z trans:" + trans.get(2));

                    // Extract the rotational components of the target relative to the robot
                    double rX = rot.firstAngle;
                    telemetry.addLine("X rotation:" + rot.firstAngle);
                    double rY = rot.secondAngle;
                    telemetry.addLine("Y rotation:" + rot.secondAngle);
                    double rZ = rot.thirdAngle;
                    telemetry.addLine("Z rotation:" + rot.thirdAngle);
                }
            }
            else {
